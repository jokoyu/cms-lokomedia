...
<!-- Header -->
<div id="header"><img src="images/images_login/img_login_header.png" alt="Lokomedia" /></div>
...
<!-- Footer -->
<div id="footer">Copyright &copy; 2009 by CMS Lokomedia and Miniw0rm. All rights reserved.</div>
